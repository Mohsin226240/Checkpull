    ...
    <footer className="bg-black border-t border-white/10 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <a
              ...
              VOID<span className="text-cyan-400">.AGENCY</span>
            </a>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                key={i}
                href="#"
                className="p-3 rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-cyan-500/20 hover:border-cyan-500/50 transition-all">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
          <p>© 2024 Void Agency. All rights reserved.</p>
