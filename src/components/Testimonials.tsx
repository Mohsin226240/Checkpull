...
const testimonials = [
{
  ...
  role: 'CTO, TechFlow',
  quote:
  "The team at Void Agency didn't just build a website, they created an experience. Our conversion rates doubled overnight.",
  image:
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="relative p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
