      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-4">
          ...
          <motion.div
            ...
            className={`border rounded-2xl overflow-hidden transition-all duration-300 ${activeIndex === index ? 'border-cyan-500/50 bg-white/5' : 'border-white/10 bg-transparent hover:border-white/20'}`}>
              ...
              className="w-full p-6 flex justify-between items-center text-left">
                ...
                <span
                className={`text-xl font-medium ${activeIndex === index ? 'text-white' : 'text-gray-400'}`}>

                  {faq.question}
                </span>
                <div
                className={`p-2 rounded-full ${activeIndex === index ? 'bg-cyan-500 text-black' : 'bg-white/10 text-white'}`}>
