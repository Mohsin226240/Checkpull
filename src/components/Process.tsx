          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <motion.div
              ...
              className="relative group">
                ...
                <div className="mb-8 relative z-10 flex justify-center">
                  ...
                  className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${step.color} p-[1px] transform rotate-45 group-hover:rotate-0 transition-transform duration-500`}>
                    ...
                    <div className="w-full h-full bg-black rounded-2xl flex items-center justify-center backdrop-blur-xl">
                      <step.icon className="w-8 h-8 text-white transform -rotate-45 group-hover:rotate-0 transition-transform duration-500" />
                    </div>
                  </div>
                ...
                <div className="text-center relative z-10 bg-black/50 backdrop-blur-sm p-4 rounded-xl">
